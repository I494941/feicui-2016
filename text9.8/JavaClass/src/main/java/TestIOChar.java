    ...
    public static void copyFileChar(String sourceFileName, String targetFilePath, String targerFileName) {
     ...
     关闭 */
        ...
        try {
            ...
            // 创建输入流对象
            InputStreamReader is = new InputStreamReader(new FileInputStream(sourceFileName), "UTF-8");

            // 创建输出流对象
            OutputStreamWriter os = new OutputStreamWriter(new FileOutputStream(targetFile), "UTF-8");
