...
public class LineView01 extends View {
   ...
   * */
    ...
    private void drawLines(Canvas canvas) {
        ...
        for (int i = 1; i < 6; i++) {
            canvas.drawLine(left, buttom - viewSize * (1 / 16f) * i, right - viewSize * (1 / 16f), buttom - viewSize * (1 / 16f) * i, linePaint);
        }
        for (int i = 1; i < 6; i++) {
            canvas.drawLine(left, buttom + viewSize * (1 / 16f) * i, right - viewSize * (1 / 16f), buttom + viewSize * (1 / 16f) * i, linePaint);
        }
        for (int i = 1; i < 7; i++) {
            canvas.drawLine(left + viewSize * (2 / 16f) * i, viewSize * (3 / 16f), left + viewSize * (2 / 16f) * i, viewSize * (13 / 16f), linePaint);
        }

        linePaint.setColor(Color.BLUE);
        for (int i = 1; i < 6; i++) {
            canvas.drawLine(left, buttom - viewSize * (1 / 16f) * i, left + viewSize * (1 / 32f), buttom - viewSize * (1 / 16f) * i, linePaint);
        }
        for (int i = 1; i < 6; i++) {
            canvas.drawLine(left, buttom + viewSize * (1 / 16f) * i, left + viewSize * (1 / 32f), buttom + viewSize * (1 / 16f) * i, linePaint);
        }
        for (int i = 1; i < 7; i++) {
            canvas.drawLine(left + viewSize * (2 / 16f) * i, viewSize * (15 / 32f), left + viewSize * (2 / 16f) * i, viewSize * (17 / 32f), linePaint);
        }
