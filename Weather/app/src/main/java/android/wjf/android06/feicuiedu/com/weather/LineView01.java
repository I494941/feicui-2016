...
public class LineView01 extends View {
    ...
    * */
    ...
    public LineView01(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public LineView01(Context context) {
        super(context);
    }
...
//
    ...
    private void drawXY(Canvas canvas) {
        ...
        * */
        ...
        mPath.moveTo(viewSize * (1 / 16f), viewSize * (3 / 16f));
        mPath.lineTo(viewSize * (2 / 16f), viewSize * (2 / 16f));
        mPath.lineTo(viewSize * (3 / 16f), viewSize * (3 / 16f));
        ...
        mPath.moveTo(viewSize * (14 / 16f), viewSize * (7 / 16f));
        mPath.lineTo(viewSize * (15 / 16f), viewSize * (8 / 16f));
        mPath.lineTo(viewSize * (14 / 16f), viewSize * (9 / 16f));
