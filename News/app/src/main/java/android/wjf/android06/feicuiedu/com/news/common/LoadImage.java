...
/*
  ...
  /*
    ...
    private Bitmap getBitmapSoftReferences(String url) {
        Bitmap bitmap = null;
    ...
    /**
     * 保存图片到缓存路径中 * @param url 图片的原路径网络 http://aa/t.jpg
     *
    ...
    /**
     * 最终调用的方法:先查看内存中有没有，再看缓存文件中有没有，最后只能向网络请求图片
     *
     * @param url 图片路径
     * @return 图片
     */
