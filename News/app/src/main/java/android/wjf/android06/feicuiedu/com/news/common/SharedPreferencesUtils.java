...
import android.wjf.android06.feicuiedu.com.news.model.entity.Register;
import android.wjf.android06.feicuiedu.com.news.model.entity.User;

/**
 * SharedPreferences存储工具类 * @author qinqy *
 */
public class SharedPreferencesUtils {
    /**
     * 此方法用于注册或者登录后，保存解析得到的内容 * @param context * @param register
     */
    ...
    /**
     * 保存用户数据 * @param context * @param user
     */
    ...
    /**
     * 获取用户令牌token * @param context * @return
     */
    ...
    /**
     * 获取用户名和用户头像地址 * @param context * @return String[] 0 --- username 1 --photo
     */
    ...
    /**
     * 保存用户头像本地路径 * @param context * @param path
     */
    ...
    /**
     * 获取保存的本地头像路劲 * @param context * @return
     */
