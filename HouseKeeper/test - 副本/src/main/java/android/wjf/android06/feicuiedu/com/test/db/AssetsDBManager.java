package android.wjf.android06.feicuiedu.com.test.db;
...
import android.wjf.android06.feicuiedu.com.test.utils.LogUtil;
...
public class AssetsDBManager {
    /**
     * 复制本地Assets中的db文件到指定目录中 * * @param context * @param path * Assets内db文件路径 * @param toFile * 目标位置 * @throws IOException
     */
    public static void copyAssetsFileToFile(Context context, String path, File toFile) throws IOException {
        ...
        BufferedInputStream buffInputStream = null; // 输出流(用来将读取到的db信息写到指定目录文件toFile中去)
