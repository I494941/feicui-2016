...
import android.wjf.android06.feicuiedu.com.housekeeper.entity.FileInfo;
import android.wjf.android06.feicuiedu.com.housekeeper.utils.FileTypeUtil;
...
// #3 如果是目录
     ...
     *
     * @param file
     * @param flag 为递归结束判断准备,每次调用方法栈内的flag 值都不一样,第一次调用的结束才是真正结束(才会调用反馈结束方法)
     */
