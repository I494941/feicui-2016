...
public class MyHandler extends Handler {
    ...
    public MyHandler(ListView lvData, Context context) {
        this.lvData = lvData;
    ...
    public void handleMessage(Message msg) {
        ...
        strUrl = "http://www.kuaidi100.com/query";
        strParams = "type=" + company + "&postid=" + orderNo;
    ...
    private class MyThread extends Thread {
        ...
        public void run() {
            ...
            Log.d(TAG, "run: strUrl = " + strUrl);
            Log.d(TAG, "run: strParams = " + strParams);
