...
import contacts.android.wjf.android06.feicuiedu.com.comfeicuieduandroid06wjf.adapter.FileAdapter;
...
/**
 * 文件列表显示界面(从FilemgrActivity 进入, 单击所有？视频文件？)
 * --------------
 */
...
// 初始设置数据
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        FileInfo fileInfo = (FileInfo) fileAdapter.getItem(position);
