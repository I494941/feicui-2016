...
/** 获取正在运行应用 */
        public Map<Integer, List<RuningAppInfo>> getRuningAppInfos () {
            Map<Integer, List<RuningAppInfo>> runingAppInfos = new
                    HashMap<Integer, List<RuningAppInfo>>();
            ...
            for (ActivityManager.RunningAppProcessInfo appProcessInfo : appProcessInfos) {
                ...
                if (importance >= ActivityManager.RunningAppProcessInfo.IMPORTANCE_SERVICE) {
                    ...
                    try {
                        ...
                        RuningAppInfo runingAppInfo = new
                                RuningAppInfo(packageName, icon, lableName, size);
                        // 系统进程
