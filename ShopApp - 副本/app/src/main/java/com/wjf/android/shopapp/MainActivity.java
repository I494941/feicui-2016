...
public class MainActivity extends AppCompatActivity {
    ...
    @BindView(R.id.iv_promote_goods_1)
    private CircleImageView ivPromoteGoods1;
    @BindView(R.id.iv_promote_goods_2)
    private CircleImageView ivPromoteGoods2;
    @BindView(R.id.iv_promote_goods_3)
    private CircleImageView ivPromoteGoods3;
    @BindView(R.id.iv_promote_goods_4)
    private CircleImageView ivPromoteGoods4;
    ...
    private void initPlayerData() {
        ...
        Glide.with(context).load(photoList.get(0).get("url")).into(ivPlayer1);
        Log.d("111111", "initPagerData: " + photoList.get(0).get("thumb"));
        Glide.with(context).load(photoList.get(1).get("url")).into(ivPlayer2);
        Glide.with(context).load(photoList.get(2).get("url")).into(ivPlayer3);
        Glide.with(context).load(photoList.get(3).get("url")).into(ivPlayer4);
        Glide.with(context).load(photoList.get(4).get("url")).into(ivPlayer5);
    ...
    private void initPromoteGoodsData() {
        ...
        ivPromoteGoods1 = (CircleImageView) findViewById(R.id.iv_promote_goods_1);
        ivPromoteGoods2 = (CircleImageView) findViewById(R.id.iv_promote_goods_2);
        ivPromoteGoods3 = (CircleImageView) findViewById(R.id.iv_promote_goods_3);
        ivPromoteGoods4 = (CircleImageView) findViewById(R.id.iv_promote_goods_4);

        Glide.with(context).load(imgList.get(0).get("thumb")).into(ivPromoteGoods1);

        Log.d("55555", "initPromoteGoodsData: " + imgList.get(0).get("small"));
        Glide.with(context).load(imgList.get(1).get("thumb")).into(ivPromoteGoods2);
        Glide.with(context).load(imgList.get(2).get("thumb")).into(ivPromoteGoods3);
        Glide.with(context).load(imgList.get(3).get("thumb")).into(ivPromoteGoods4);
    }
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                for (int i = 0; i < promoteGoodsList.size(); i++) {
                    ...
                    Log.d("3333", "onResponse: " + imgMap.toString());
                    imgList.add(imgMap);
                }
    ...
    private void initCategoryData() {
        ...
        Glide.with(context).load(imgMap21.get("thumb")).into(ivCategory21);
        Glide.with(context).load(imgMap22.get("thumb")).into(ivCategory22);
        Glide.with(context).load(imgMap23.get("thumb")).into(ivCategory23);
        Glide.with(context).load(imgMap24.get("thumb")).into(ivCategory24);
        ...
        Glide.with(context).load(imgMap31.get("thumb")).into(ivCategory31);
        Glide.with(context).load(imgMap32.get("thumb")).into(ivCategory32);
        Glide.with(context).load(imgMap33.get("thumb")).into(ivCategory33);
        Glide.with(context).load(imgMap34.get("thumb")).into(ivCategory34);
        Glide.with(context).load(imgMap35.get("thumb")).into(ivCategory35);
    }
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                Log.d("11111", "handleMessage: " + photoList.toString());
            } else if (msg.what == 2) {

                imgList = (List<Map<String, String>>) msg.obj;
                Log.d("22222", "handleMessage: " + imgList.toString());
            } else if (msg.what == 3) {
                ...
                Log.d("1111", "onResponse: " + map.get("data").toString());

                dataList = (List<Map<String, Object>>) map.get("data");
                Log.d("23333", "handleMessage: " + dataList.toString());
            }
            initPlayerData();
            initCategoryData();
