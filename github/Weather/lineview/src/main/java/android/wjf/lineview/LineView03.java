...
public class LineView03 extends View {
    ...
    * */
    ...
    public LineView03(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public LineView03(Context context) {
        super(context);
    }
...
//        Log.i("Text","remainderY:--"+remainderY);
        ...
        if (remainderY == 0 && (maxY - minY) == 0) {
            ...
            maxY = maxY + (2 - maxY % 2);
            maxY = maxY + (divisor - maxY % divisor);
            if (minY >= 0) {
                minY = minY + (2 - minY % 2);
            } else {
                minY = minY + (-2 - minY % 2);
...
//        Log.i("Text","rulerX:--"+rulerX);
        ...
        for (float y = buttom - spaceY; y > top; y -= spaceY) {
            for (float x = lift; x < right; x += spaceX) {
                 ...
                 */
                if (x == lift) {
                    canvas.drawText((int) (rulerY[num_y + 1] + minY) + "", lift - (lift / 2), y + 10, mTextPaint);
    ...
    private void drawText(Canvas canvas) {
         ...
         */
            for (int i = 0; i < pointFs.size(); i++) {
                ...
                // 计算y坐标
                float y = mCanvas.getHeight() / maxY * (pointFs.get(i).y - minY);
